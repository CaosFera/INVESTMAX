...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(blank=True, default='users/images/user_deafault.png', null=True, upload_to='users/images/', verbose_name='Photo')),
                ...
                ('investment', models.ManyToManyField(related_name='investments', to='investments.investments')),
